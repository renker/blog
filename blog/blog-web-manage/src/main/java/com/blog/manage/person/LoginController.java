...
public class LoginController extends BaseController{
	...
	@ResponseBody
	public com.blog.common.ui.JsonResult unauthorizedAjax(Model model,HttpServletRequest request,String errorMsg){
		return JsonResult(Status.UNAUTHORIZED,errorMsg);
	}
}
